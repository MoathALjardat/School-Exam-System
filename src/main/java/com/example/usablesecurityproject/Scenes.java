...
public class Scenes {
    ...
    public static Scene logInAsStudentScene(Stage AnwarsStage) {
        ...
        Button secondWay = new Button("Second Way");
        secondWay.setLayoutX(665);
        secondWay.setLayoutY(99);
        secondWay.setPrefHeight(56);
        secondWay.setPrefWidth(118);

        secondWay.setOnAction(h -> {
            AnwarsStage.close();
            AnwarsStage.setScene(secondWayAuthentication(AnwarsStage));
            AnwarsStage.show();
        });
        ...
        pane.getChildren().addAll(imageView, computersIV, back, signIn, nameLabel, PasswordLabel, NameTF,
                PasswordTF, secondWay);
        Scene scene7 = new Scene(pane, 800, 600);
        return scene7;

    }

    public static Scene secondWayAuthentication(Stage AnwarsStage) {
        Image image = new Image("file:pic1.jpg");
        ImageView imageView = new ImageView(image);

        Label questionLabel = new Label("Question");
        questionLabel.setLayoutX(6.0);
        questionLabel.setLayoutY(70.0);
        questionLabel.setPrefHeight(35.0);
        questionLabel.setPrefWidth(60);

        Label answerLabel = new Label("Answer");
        answerLabel.setLayoutX(6.0);
        answerLabel.setLayoutY(172.0);
        answerLabel.setPrefHeight(17.0);
        answerLabel.setPrefWidth(66.0);

        TextField questionField = new TextField();
        questionField.setLayoutX(100);
        questionField.setLayoutY(75);

        PasswordField answerField = new PasswordField();
        answerField.setLayoutX(100);
        answerField.setLayoutY(168);
        ...
        signIn.setOnAction(g -> {
            if (answerField.getText().isEmpty() || questionField.getText().isEmpty()) {
                ...
                try {
                    Student s = Queries.getStudentForSignInByAnswerAQuestion(answerField.getText(), questionField.getText());
                    if (s == null) {
                        AlertBox.display("please check if the data entered is correct");
        ...
        back.setOnAction(h -> {
            AnwarsStage.close();
            AnwarsStage.setScene(logInAsStudentScene(AnwarsStage));
            AnwarsStage.show();
        });
        ...
        Pane pane = new Pane();
        pane.getChildren().addAll(imageView, computersIV, back, signIn,answerLabel,questionLabel, questionField,answerField);
        Scene scene7 = new Scene(pane, 800, 600);
        return scene7;
    ...
    public static Scene viewPersonalInfoScene(Stage AnwarsStage, Student student) {
		...
		Button enableSecondWay = new Button("Enable Second Way log in ?");
		enableSecondWay.setLayoutX(5);
		enableSecondWay.setLayoutY(5);
        enableSecondWay.setOnAction(g -> {
            AnwarsStage.close();
            AnwarsStage.setScene(addPersonalQuestion(AnwarsStage,student));
            AnwarsStage.show();
        });
        ...
        pane.getChildren().addAll(imageView, computersPicIV, backToChooseMenu, signOutToChooseMenu, idTF, NameTF,
                PasswordTF, enableSecondWay,BudgetTF, AddBudgetTF, idLabel, nameLabel, PasswordLabel, BudgetLabel, addBudgetLabel,
                addBudgetButton);
        Scene scene6 = new Scene(pane, 800, 600);
        return scene6;
    }

    public static Scene addPersonalQuestion(Stage AnwarsStage, Student student) {

        Image image = new Image("file:pic1.jpg");
        ImageView imageView = new ImageView(image);
        Label questionLabel = new Label("Question");
        questionLabel.setLayoutX(6.0);
        questionLabel.setLayoutY(65);
        questionLabel.setPrefHeight(60);
        questionLabel.setPrefWidth(42.0);



        Label answerLabel = new Label("Answer");
        answerLabel.setLayoutX(8.0);
        answerLabel.setLayoutY(223.0);


        TextField questionField = new TextField();
        questionField.setText(student.getQuestion());
        questionField.setLayoutX(100);
        questionField.setLayoutY(75);

        TextField answerField = new TextField(student.getAnswer());
        answerField.setLayoutX(100);
        answerField.setLayoutY(219);



        Button saveButton = new Button("Save");
        saveButton.setLayoutX(614);
        saveButton.setLayoutY(486);
        saveButton.setPrefHeight(56);
        saveButton.setPrefWidth(118);

        saveButton.setOnAction(g -> {
            try {
                student.setQuestion(questionField.getText());
                student.setAnswer(answerField.getText());
                Queries.savePersonalQuestion(student);
            ...
            AnwarsStage.close();
            AnwarsStage.setScene(viewPersonalInfoScene(AnwarsStage,student));
            AnwarsStage.show();
        });

        Button backToStudentInfoScene = new Button("Back");
        backToStudentInfoScene.setLayoutX(465);
        backToStudentInfoScene.setLayoutY(486);
        backToStudentInfoScene.setPrefHeight(56);
        backToStudentInfoScene.setPrefWidth(118);

        backToStudentInfoScene.setOnAction(h -> {
            AnwarsStage.close();
            AnwarsStage.setScene(viewPersonalInfoScene(AnwarsStage, student));
            AnwarsStage.show();
        });
        ...
        Pane pane = new Pane();
        pane.getChildren().addAll(imageView, computersPicIV, backToStudentInfoScene, saveButton, questionField,
               answerField, questionLabel,  answerLabel);
        Scene scene6 = new Scene(pane, 800, 600);
        return scene6;
    }
